...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RESERVATION_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Young'), '2020-01-01');
